            ...
            <ul class="side-menu top">
                ...
                <li>
                    <a href="bus.php">
                        ...
                        <button class="dropbtn"><span class="text">bus</span></button>
                        <div class="dropdown-content">
                            <a href="add bus.php">Add bus</a></br>
                            <a href="remove bus.php">Remove bus</a></br>
                            <a href="allbus.php">All bus</a></br>
                          </div>
                    </a>
            ...
            <main>
                ...
                <ul class="box-info">
                    ...
                    <li>
                        <i class='bx bxs-car'></i>
                        <span class="text">
                        <h1>Number of bus: <?php echo $count; ?></h1>
