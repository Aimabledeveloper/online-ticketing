            ...
            <ul class="side-menu top">
                ...
                <li>
                    <a href="#">
                        ...
                        <button class="dropbtn"><span class="text">Ticket</span></button>
                        <div class="dropdown-content">
                            <a href="add ticket.php">Add tickets</a></br>
                            <a href="edit ticket.php">Edit tickets</a></br>
                            <a href="booked.php">Booked tickets</a></br>
                            <a href="alltickets.php">All tickets</a></br>
                            <a href="deletticket.php">Delet ticket</a>
                          </div>
                    </a>
                ...
                <ul class="box-info">
                   <li>
                    ...
                    <li>
                        ...
                        <span class="text">
                        <h1> booked: <?php echo $usernameCount; ?></h1>
                        </span>
                    </li>
