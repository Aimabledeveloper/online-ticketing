...
if (isset($_POST["submit"])) {
    ...
    $stmt = $conn->prepare("INSERT INTO edditticket (ticketid, departure, platenumber, location, arrival, price, time, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
