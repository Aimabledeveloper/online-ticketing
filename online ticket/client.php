...
$sql = "SELECT COUNT(*) AS count FROM create_account";
            ...
            <ul class="side-menu top">
                ...
                <li>
                    <a href="client.php">
                        ...
                        <button class="dropbtn"><span class="text">client</span></button>
                        <div class="dropdown-content">
                            
                            <a href="allclient.php">All client</a></br>
                          </div>
                    </a>
                </li>
                <li>
            ...
            <main>
                ...
                <ul class="box-info">
                    ...
                    <li>
                        <i class='bx bxs-car'></i>
                        <span class="text">
                        <h1>All client: <?php echo $count; ?></h1>
